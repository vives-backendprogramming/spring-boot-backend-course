...
public class PizzaController {
    ...
    public ResponseEntity<PizzaResponse> getPizza(@PathVariable Long id) {
        ...
        return pizzaService.findById(id)
                ...
                .orElseThrow(() -> new be.vives.pizzastore.exception.ResourceNotFoundException("Pizza", id));
    }

    @PostMapping
    public ResponseEntity<PizzaResponse> createPizza(@jakarta.validation.Valid @RequestBody CreatePizzaRequest request) {
    ...
    public ResponseEntity<PizzaResponse> updatePizza(
            ...
            @jakarta.validation.Valid @RequestBody UpdatePizzaRequest request) {
    ...
    public ResponseEntity<Void> deletePizza(@PathVariable Long id) {
        ...
        if (!pizzaService.delete(id)) {
            throw new be.vives.pizzastore.exception.ResourceNotFoundException("Pizza", id);
        }
