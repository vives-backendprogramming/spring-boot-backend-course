...
-- Customers (authenticated via OIDC - no password stored locally)
-- Sub field contains the OIDC subject identifier from Dex IdP
INSERT INTO customers (name, email, sub, phone, address, role, created_at, updated_at) VALUES
...
-- Pre-registered users that match Dex static passwords
('Admin User', 'admin@pizzastore.com', '08a8684b-db88-4b73-90a9-3cd1661f5466', '+32 475 67 89 01', 'Headquarters, 1000 Brussels', 'ADMIN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Customer User', 'customer@pizzastore.com', '41331323-6f44-45e6-b3b9-2c4b60c02be5', '+32 476 78 90 12', 'Test Street 1, 1000 Brussels', 'CUSTOMER', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
